...
@Component({
  selector: 'app-group-card-timetable-page',
  templateUrl: './group-card-timetable.page.html',
  styleUrls: ['./group-card-timetable.page.less']
})
export class GroupCardTimetablePage {
